 ...
 * @author Admin
 */
public class LayRaNhanVien {

    private String maNV, hoVaTen, matKhau, diaChi, email, sdt;
    private boolean gioiTinh, vaiTro, trangThai;

    public LayRaNhanVien() {
    }

    public LayRaNhanVien(String maNV, String hoVaTen, String matKhau, String diaChi, String email, String sdt, boolean gioiTinh, boolean vaiTro, boolean trangThai) {
        this.maNV = maNV;
    ...
    public LayRaNhanVien(String maNV) {
        this.maNV = maNV;
    }
