...
public class LayRaKhuyenMai {
    ...
    public LayRaKhuyenMai() {
    }

    public LayRaKhuyenMai(Integer ID, String ma, String tenKhuyenMai, Integer loaiKhuyenMai, Double DonGiamToiThieu, Date ngayBatDau, Date ngayKetThuc, Double giaTri, String trangThai) {
        this.ID = ID;
        this.ma = ma;
    ...
    public LayRaKhuyenMai(String ma, String tenKhuyenMai, Integer loaiKhuyenMai, Double DonGiamToiThieu, Date ngayBatDau, Date ngayKetThuc, Double giaTri, String trangThai) {
        this.ma = ma;
        this.tenKhuyenMai = tenKhuyenMai;
        this.loaiKhuyenMai = loaiKhuyenMai;
        this.DonGiamToiThieu = DonGiamToiThieu;
